    ...
    <div className="p-3 p-md-4">
      <div className="mb-4">
        <h2 className="fw-bold text-white mb-1 d-flex align-items-center gap-2">
          <Shield size={30} style={{ color: '#10b981' }} /> Admin Control Center
        </h2>
        <p className="small mb-0" style={{ color: '#8b949e' }}>System configurations, user role management, and SLA target definitions</p>
      </div>
      ...
      <Modal show={showCatModal} onHide={() => setShowCatModal(false)} centered className="modal-dark">
        <Modal.Header closeButton className="border-secondary">
          <Modal.Title className="fw-bold text-white">Add New Category</Modal.Title>
        </Modal.Header>
        <Modal.Body>
      ...
      <Modal show={showPrioModal} onHide={() => setShowPrioModal(false)} centered className="modal-dark">
        <Modal.Header closeButton className="border-secondary">
          <Modal.Title className="fw-bold text-white">Add Priority & SLA</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form.Group className="mb-3">
