...
import { Bell, User, LogOut, Ticket, Settings, LogIn, Headphones } from 'lucide-react';
      ...
      <Navbar expand="lg" className="navbar-custom sticky-top py-2 px-0">
        <Container fluid className="px-3 px-md-5">
          <Navbar.Brand as={Link} to={user ? '/dashboard' : '/'} className="d-flex align-items-center gap-2 text-decoration-none">
            <div className="p-2 rounded-circle" style={{ background: 'rgba(16, 185, 129, 0.15)', border: '1px solid rgba(16, 185, 129, 0.3)' }}>
              <Headphones className="text-success" size={24} style={{ color: '#10b981' }} />
            </div>
            <span className="navbar-brand-gradient">ServiceDesk</span>
          </Navbar.Brand>
              ...
              {user ? (
                  ...
                  <NavDropdown
                    title={
                      <span className="d-inline-flex align-items-center gap-2 text-dark">
                        <span
                          className="rounded-circle text-dark d-inline-flex align-items-center justify-content-center fw-bold shadow-sm"
                          style={{ width: 36, height: 36, background: 'linear-gradient(135deg, #10b981, #34d399)' }}
                        >
                          {user.firstName ? user.firstName.charAt(0) : 'U'}
                        </span>
                        <span className="fw-bold d-none d-md-inline" style={{ color: 'var(--text-dark)' }}>{user.firstName} {user.lastName}</span>
                      </span>
                    }
                    id="user-dropdown"
                    align="end"
                ...
                <div className="d-flex align-items-center gap-2">
                  <Button
                    ...
                    className="btn-indigo px-4 py-2 d-flex align-items-center gap-1 fw-bold"
                  >
