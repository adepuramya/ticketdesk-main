...
export const CreateTicket = () => {
  ...
  return (
    <div className="p-3 p-md-4 max-w-4xl mx-auto">
      <Button variant="link" onClick={() => navigate(-1)} className="text-decoration-none p-0 mb-3 d-flex align-items-center gap-1 fw-bold" style={{ color: '#10b981' }}>
      ...
      <Card className="glass-card p-4 p-md-5">
        <div className="mb-4">
          ...
          <p className="small mb-0" style={{ color: '#8b949e' }}>Submit an issue or request to the IT engineering team</p>
        </div>
