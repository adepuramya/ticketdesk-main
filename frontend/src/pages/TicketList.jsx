    ...
    <div className="p-3 p-md-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="small mb-0" style={{ color: '#8b949e' }}>Search, filter, and manage support tickets</p>
        </div>
      </div>
        ...
        <Row className="g-2">
          <Col md={4}>
            <Form onSubmit={handleSearchSubmit}>
              <InputGroup>
                <InputGroup.Text className="text-secondary" style={{ background: '#1f242d', borderColor: '#30363d', borderRight: 'none' }}>
                  <Search size={18} />
                </InputGroup.Text>
                <Form.Control
                  type="text"
